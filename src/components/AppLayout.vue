  ...
  <div class="app-layout">
    ...
    <aside class="sidebar" :class="{ 'sidebar-collapsed': sidebarCollapsed }">
      ...
      <nav class="sidebar-nav">
        ...
        <router-link v-if="canCreateRequest" to="/requests/new" class="nav-item" active-class="active">
          <svg width="20" height="20" fill="currentColor" viewBox="0 0 20 20">
        ...
        <router-link v-if="canViewOwnRequests" to="/requests" class="nav-item" active-class="active">
          <svg width="20" height="20" fill="currentColor" viewBox="0 0 20 20">
